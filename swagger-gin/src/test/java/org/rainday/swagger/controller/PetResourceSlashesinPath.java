...
import org.rainday.swagger.model.Category;
import org.rainday.swagger.model.NotFoundException;
import org.rainday.swagger.model.Pet;
import org.rainday.swagger.model.PetData;
import org.rainday.swagger.model.QueryResultBean;
...
import org.rainday.ws.rs.methods.GET;
import org.rainday.ws.rs.methods.POST;
import org.rainday.ws.rs.methods.PUT;
...
public class PetResourceSlashesinPath {
    ...
    public String addPetNoAnnotation(Pet pet) {
        petData.addPet(pet);
        return "";
    }
    ...
    public String addPetByIntegerNoAnnotation(int petId) {
        return "";
    }
    ...
    public String findPetsByCategory(
